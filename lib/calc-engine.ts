...
export const CALC_TEMPLATES: CalcTemplate[] = [
  ...
  { id: 'alv_cinta',      ativo: true, nome: 'Cinta de coroamento superior',                   grupo_id: 'alvenaria', grupo_nome: 'Paredes e Painéis', etapa_codigo: '04', sub_etapa: 'Cinta de Coroamento', composicao_id: 'cmp-4003', descricao: 'Cinta de Coroamento em Canela Cerâmica', unidade: 'm', formula: 'cinta_coroamento == 1 ? comp_paredes : 0', parametros: ['cinta_coroamento', 'comp_paredes'] },
